            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  ...
                  weddings, portraits, events, commercial shoots, product
                  photography, and nature photography. Check our Services page
                  for more details.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  ...
                  time, and fill out the form. We’ll confirm your booking within
                  24 hours.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent>
                  ...
                  work, including past events, portraits, and commercial shoots.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
