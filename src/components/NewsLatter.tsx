        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="max-w-xl lg:max-w-lg">
              ...
              <p className="mt-4 text-lg leading-8 subtitle">
                ...
                techings of the great explorer of the truth, the moster-builder
                of human happiness.
              </p>
            ...
            <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
              <div className=" flex flex-col items-start">
                ...
                <dt className="mt-4 font-semibold text-muted-foreground">Weeklyv articles</dt>
                <dd className="mt-2 leading-7">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. In,
                  molestiae sequi! Ad et, blanditiis omnis dicta, nobis nostrum
                  consequatur fugit magni perspiciatis dolores suscipit aliquam
                  atque ex adipisci illo? Expedita.
                </dd>
              </div>
              <div className=" flex flex-col items-start">
                <div className="bg-primary p-2 ring-1 ring-white/10 rounded-full" >
